...
/* DEBUG start */
void log_audio_device_offsets(void* adev_void) {
    // Cast to the appropriate struct type
    struct audio_device *adev = (struct audio_device *)adev_void;

    // Base address
    uintptr_t base = (uintptr_t)adev;
    
    // First section - Basic fields
    ALOGD("%s: audio_device base address: %p", __func__, adev);
    ALOGD("%s: Offset of lock: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->lock - base, (uintptr_t)&adev->lock - base);
    ALOGD("%s: Offset of cal_lock: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->cal_lock - base, (uintptr_t)&adev->cal_lock - base);
    ALOGD("%s: Offset of mixer: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->mixer - base, (uintptr_t)&adev->mixer - base);
    ALOGD("%s: Offset of mode: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->mode - base, (uintptr_t)&adev->mode - base);
    ALOGD("%s: Offset of prev_mode: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->prev_mode - base, (uintptr_t)&adev->prev_mode - base);
    ALOGD("%s: Offset of out_device: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->out_device - base, (uintptr_t)&adev->out_device - base);
    ALOGD("%s: Offset of primary_output: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->primary_output - base, (uintptr_t)&adev->primary_output - base);
    
    // Outputs and Bluetooth related
    ALOGD("%s: Offset of voice_tx_output: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->voice_tx_output - base, (uintptr_t)&adev->voice_tx_output - base);
    ALOGD("%s: Offset of current_call_output: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->current_call_output - base, (uintptr_t)&adev->current_call_output - base);
    ALOGD("%s: Offset of bluetooth_nrec: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->bluetooth_nrec - base, (uintptr_t)&adev->bluetooth_nrec - base);
    ALOGD("%s: Offset of screen_off: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->screen_off - base, (uintptr_t)&adev->screen_off - base);
    
    // Lists and audio configuration
    ALOGD("%s: Offset of snd_dev_ref_cnt: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->snd_dev_ref_cnt - base, (uintptr_t)&adev->snd_dev_ref_cnt - base);
    ALOGD("%s: Offset of usecase_list: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->usecase_list - base, (uintptr_t)&adev->usecase_list - base);
    ALOGD("%s: Offset of streams_output_cfg_list: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->streams_output_cfg_list - base, (uintptr_t)&adev->streams_output_cfg_list - base);
    ALOGD("%s: Offset of streams_input_cfg_list: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->streams_input_cfg_list - base, (uintptr_t)&adev->streams_input_cfg_list - base);
    ALOGD("%s: Offset of audio_route: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->audio_route - base, (uintptr_t)&adev->audio_route - base);
    ALOGD("%s: Offset of acdb_settings: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->acdb_settings - base, (uintptr_t)&adev->acdb_settings - base);
    
    // Speaker and voice
    ALOGD("%s: Offset of speaker_lr_swap: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->speaker_lr_swap - base, (uintptr_t)&adev->speaker_lr_swap - base);
    ALOGD("%s: Offset of voice: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->voice - base, (uintptr_t)&adev->voice - base);
    
    // HDMI and display
    ALOGD("%s: Offset of cur_hdmi_channels: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->cur_hdmi_channels - base, (uintptr_t)&adev->cur_hdmi_channels - base);
    ALOGD("%s: Offset of cur_hdmi_format: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->cur_hdmi_format - base, (uintptr_t)&adev->cur_hdmi_format - base);
    ALOGD("%s: Offset of cur_hdmi_sample_rate: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->cur_hdmi_sample_rate - base, (uintptr_t)&adev->cur_hdmi_sample_rate - base);
    ALOGD("%s: Offset of cur_hdmi_bit_width: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->cur_hdmi_bit_width - base, (uintptr_t)&adev->cur_hdmi_bit_width - base);
    ALOGD("%s: Offset of cur_wfd_channels: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->cur_wfd_channels - base, (uintptr_t)&adev->cur_wfd_channels - base);
    
    // Bluetooth and features
    ALOGD("%s: Offset of bt_wb_speech_enabled: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->bt_wb_speech_enabled - base, (uintptr_t)&adev->bt_wb_speech_enabled - base);
    ALOGD("%s: Offset of swb_speech_mode: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->swb_speech_mode - base, (uintptr_t)&adev->swb_speech_mode - base);
    ALOGD("%s: Offset of allow_afe_proxy_usage: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->allow_afe_proxy_usage - base, (uintptr_t)&adev->allow_afe_proxy_usage - base);
    ALOGD("%s: Offset of is_charging: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->is_charging - base, (uintptr_t)&adev->is_charging - base);
    
    // Microphone and settings
    ALOGD("%s: Offset of mic_break_enabled: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->mic_break_enabled - base, (uintptr_t)&adev->mic_break_enabled - base);
    ALOGD("%s: Offset of enable_hfp: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->enable_hfp - base, (uintptr_t)&adev->enable_hfp - base);
    ALOGD("%s: Offset of mic_muted: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->mic_muted - base, (uintptr_t)&adev->mic_muted - base);
    ALOGD("%s: Offset of enable_voicerx: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->enable_voicerx - base, (uintptr_t)&adev->enable_voicerx - base);
    ALOGD("%s: Offset of num_va_sessions: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->num_va_sessions - base, (uintptr_t)&adev->num_va_sessions - base);
    
    // Sound card and status
    ALOGD("%s: Offset of snd_card: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->snd_card - base, (uintptr_t)&adev->snd_card - base);
    ALOGD("%s: Offset of card_status: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->card_status - base, (uintptr_t)&adev->card_status - base);
    ALOGD("%s: Offset of out_power_policy: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->out_power_policy - base, (uintptr_t)&adev->out_power_policy - base);
    ALOGD("%s: Offset of in_power_policy: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->in_power_policy - base, (uintptr_t)&adev->in_power_policy - base);
    
    // Codec and format
    ALOGD("%s: Offset of cur_codec_backend_samplerate: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->cur_codec_backend_samplerate - base, (uintptr_t)&adev->cur_codec_backend_samplerate - base);
    ALOGD("%s: Offset of cur_codec_backend_bit_width: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->cur_codec_backend_bit_width - base, (uintptr_t)&adev->cur_codec_backend_bit_width - base);
    ALOGD("%s: Offset of is_channel_status_set: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->is_channel_status_set - base, (uintptr_t)&adev->is_channel_status_set - base);
    
    // Platform and speaker
    ALOGD("%s: Offset of platform: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->platform - base, (uintptr_t)&adev->platform - base);
    ALOGD("%s: Offset of extspk: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->extspk - base, (uintptr_t)&adev->extspk - base);
    
    // Usecases
    ALOGD("%s: Offset of offload_usecases_state: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->offload_usecases_state - base, (uintptr_t)&adev->offload_usecases_state - base);
    ALOGD("%s: Offset of pcm_record_uc_state: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->pcm_record_uc_state - base, (uintptr_t)&adev->pcm_record_uc_state - base);
    ALOGD("%s: Offset of pcm_low_latency_record_uc_state: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->pcm_low_latency_record_uc_state - base, (uintptr_t)&adev->pcm_low_latency_record_uc_state - base);
    
    // Visualizer and effects
    ALOGD("%s: Offset of visualizer_lib: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->visualizer_lib - base, (uintptr_t)&adev->visualizer_lib - base);
    ALOGD("%s: Offset of visualizer_start_output: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->visualizer_start_output - base, (uintptr_t)&adev->visualizer_start_output - base);
    ALOGD("%s: Offset of visualizer_stop_output: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->visualizer_stop_output - base, (uintptr_t)&adev->visualizer_stop_output - base);
    ALOGD("%s: Offset of offload_effects_lib: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->offload_effects_lib - base, (uintptr_t)&adev->offload_effects_lib - base);
    ALOGD("%s: Offset of offload_effects_start_output: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->offload_effects_start_output - base, (uintptr_t)&adev->offload_effects_start_output - base);
    ALOGD("%s: Offset of offload_effects_stop_output: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->offload_effects_stop_output - base, (uintptr_t)&adev->offload_effects_stop_output - base);
    ALOGD("%s: Offset of offload_effects_set_hpx_state: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->offload_effects_set_hpx_state - base, (uintptr_t)&adev->offload_effects_set_hpx_state - base);
    
    // ADM and library fields
    ALOGD("%s: Offset of adm_data: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->adm_data - base, (uintptr_t)&adev->adm_data - base);
    ALOGD("%s: Offset of adm_lib: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->adm_lib - base, (uintptr_t)&adev->adm_lib - base);
    ALOGD("%s: Offset of adm_init: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->adm_init - base, (uintptr_t)&adev->adm_init - base);
    ALOGD("%s: Offset of adm_deinit: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->adm_deinit - base, (uintptr_t)&adev->adm_deinit - base);
    ALOGD("%s: Offset of adm_register_input_stream: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->adm_register_input_stream - base, (uintptr_t)&adev->adm_register_input_stream - base);
    ALOGD("%s: Offset of adm_register_output_stream: 0x%zx (%zu)", __func__, 
          (uintptr_t)&adev->adm_register_output_stream - base, (uintptr_t)&adev->adm_register_output_stream - base);
    
    // Also log offset 0x1d4 specifically for investigation
    ALOGD("%s: Value at offset 0x1d4 (468): 0x%x", __func__, 
          *(int *)((char *)adev + 0x1d4));
}
/* DEBUG end */
